...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(types_1.UserRole.ADMIN, types_1.UserRole.CLIENT),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new project (Requirement submission)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update project status (Admin only)' }),
    __param(0, (0, common_1.Param)('id')),
